...
def config(parser):
    ...
    # language model
    parser.add_argument('-m', '--model', help='language model', default='roberta', type=str)
    ...
    # data
    parser.add_argument('--data', help='dataset', default='', type=str)
